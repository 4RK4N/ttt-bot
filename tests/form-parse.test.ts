...
describe("parseBracketForm", () => {
  ...
  it("parses nested object-list keys", () => {
    ...
    expect(tree.panels).toEqual([
      { id: "a", channelId: "123", panelTitle: "Title" },
    ]);
  });
